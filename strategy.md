...
| Board View: blockers/achievements/reports | CODE | done | medium | ✅ Connected to /api/projects/:id + /api/tasks summary |
...
| Activity logging from dashboard actions | CODE | in_progress | medium | Emit /api/activity events on create/update actions |
...
- 2026-02-08: Activity Monitor shipped (CLAUDE) — /activity + /api/activity/*
- 2026-02-08: Dashboard portfolio features shipped (CODE) — /controller, /projects/:id, board refresh, thread creation UI
...
- 2026-02-08 [CODE]: Project detail page (/projects/:id) + controller page + board refresh + thread creation UI
